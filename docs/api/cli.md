...
- `migrateCommand` - function in `commands/tooling.ts`
- `MigrateCommandOptions` - interface in `commands/tooling.ts`
- `packageCommand` - function in `commands/package.ts`
...
- `ReleaseCheckOptions` - interface in `commands/release.ts`
- `releaseSnapshotCommand` - function in `commands/release.ts`
- `ReleaseSnapshotOptions` - interface in `commands/release.ts`
- `removeDependencyCommand` - function in `commands/dependencies.ts`
- `resolveTemplate` - function in `scaffold/templates.ts`
...
- `TestCommandOptions` - interface in `commands/workspace.ts`
- `testComponentCommand` - function in `commands/tooling.ts`
- `updateDependencyCommand` - function in `commands/dependencies.ts`
- `validateScaffold` - function in `scaffold/project.ts`
