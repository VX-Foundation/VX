...
Skeleton is a feedback widget lowered to `<div>` in client and SSR output.
...
- Prefer Skeleton over recreating its <div> contract through an untyped wrapper.
