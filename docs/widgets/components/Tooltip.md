...
Tooltip is a feedback widget lowered to `<span>` in client and SSR output.
...
- Prefer Tooltip over recreating its <span> contract through an untyped wrapper.
