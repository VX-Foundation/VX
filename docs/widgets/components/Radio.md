...
Radio is a control widget lowered to `<input>` in client and SSR output.
...
- Prefer Radio over recreating its <input> contract through an untyped wrapper.
