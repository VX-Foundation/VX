...
VirtualList is a data widget lowered to `<div>` in client and SSR output.
...
- Prefer VirtualList over recreating its <div> contract through an untyped wrapper.
